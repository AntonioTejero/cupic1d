...
#field_model[0] = E_P
#field2_model[0] = E_P*E_P
#position_model[0] = 0
#puts "#{position_model[0].to_i} \t #{potential_model[0]} \t #{field_model[0]}"
...
#(1..NODES-1).step do |index|
  ...
  #puts "#{position_model[index].to_i} \t #{potential_model[index]} \t #{field_model[index]}"
#end
